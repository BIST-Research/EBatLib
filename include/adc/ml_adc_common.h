...
#define ML_ADC_WINMON_CLR_INTFLAG(instance)                                    \
  (instance->INTFLAG.bit.WINMON = 0x01)
#define ML_ADC_OVERRUN_CLR_INTFLAG(instance)                                   \
  (instance->INTFLAG.bit.OVERRUN = 0x01)
#define ML_ADC_RESRDY_CLR_INTFLAG(instance)                                    \
  (instance->INTFLAG.bit.RESRDY = 0x01)

#define ML_ADC_CLR_INTFLAGS(instance) (instance->INTFLAG.reg = ADC_INTFLAG_MASK)

// #define PASTE_FUSE(REG) ((*((uint32_t *) (REG##_ADDR)) & (REG##_Msk)) >>
// (REG##_Pos))
