...
#include <sercom/ml_sercom.h>
#include <tc/ml_tc_common.h>
...
void spi_dmac_tx_init(ml_dmac_s *dmac_s, Sercom *coms_inst,
                      DmacDescriptor *cpy);

void spi_dmac_rx_init(ml_dmac_s *dmac_s, Sercom *coms_inst,
                      DmacDescriptor *cpy);

#define ML_SERCOM_SPI_INTSET_DRE(instance)                                     \
  (instance->SPI.INTENSET.bit.DRE = 0x01)
#define ML_SERCOM_SPI_INTSET_TXC(instance)                                     \
  (instance->SPI.INTENSET.bit.TXC = 0x01)
#define ML_SERCOM_SPI_INTSET_RXC(instance)                                     \
  (instance->SPI.INTENSET.bit.RXC = 0x01)
#define ML_SERCOM_SPI_INTSET_SSL(instance)                                     \
  (instance->SPI.INTENSET.bit.SSL = 0x01)
#define ML_SERCOM_SPI_INTSET_ERR(instance)                                     \
  (instance->SPI.INTENSET.bit.ERROR = 0x01)

#define ML_SERCOM_SPI_INTCLR_DRE(instance)                                     \
  (instance->SPI.INTENCLR.bit.DRE = 0x01)
#define ML_SERCOM_SPI_INTCLR_TXC(instance)                                     \
  (instance->SPI.INTENCLR.bit.TXC = 0x01)
#define ML_SERCOM_SPI_INTCLR_RXC(instance)                                     \
  (instance->SPI.INTENCLR.bit.RXC = 0x01)
#define ML_SERCOM_SPI_INTCLR_SSL(instance)                                     \
  (instance->SPI.INTENCLR.bit.SSL = 0x01)
#define ML_SERCOM_SPI_INTCLR_ERR(instance)                                     \
  (instance->SPI.INTENCLR.bit.ERROR = 0x01)

#define ML_SERCOM_SPI_DRE_CLR_INTFLAG(instance)                                \
  (instance->SPI.INTFLAG.bit.DRE = 0x01)
#define ML_SERCOM_SPI_TXC_CLR_INTFLAG(instance)                                \
  (instance->SPI.INTFLAG.bit.TXC = 0x01)
#define ML_SERCOM_SPI_RXC_CLR_INTFLAG(instance)                                \
  (instance->SPI.INTFLAG.bit.RXC = 0x01)
#define ML_SERCOM_SPI_SSL_CLR_INTFLAG(instance)                                \
  (instance->SPI.INTFLAG.bit.SSL = 0x01)
#define ML_SERCOM_SPI_ERR_CLR_INTFLAG(instance)                                \
  (instance->SPI.INTFLAG.bit.ERROR = 0x01)

#define ML_SERCOM_SPI_DRE_INTFLAG(instance)                                    \
  (instance->SPI.INTFLAG.bit.DRE == 0x01)
#define ML_SERCOM_SPI_TXC_INTFLAG(instance)                                    \
  (instance->SPI.INTFLAG.bit.TXC == 0x01)
#define ML_SERCOM_SPI_RXC_INTFLAG(instance)                                    \
  (instance->SPI.INTFLAG.bit.RXC == 0x01)
#define ML_SERCOM_SPI_SSL_INTFLAG(instance)                                    \
  (instance->SPI.INTFLAG.bit.SSL == 0x01)
#define ML_SERCOM_SPI_ERR_INTFLAG(instance)                                    \
  (instance->SPI.INTFLAG.bit.ERROR == 0x01)
