...
typedef enum _ml_tc_cc_t { CC0, CC1 } ml_tc_cc_t;
...
void TC_channel_capture_compare_set(Tc *instance, const ml_tc_cc_t channel,
                                    const uint8_t ccval);
...
#define ML_TC_OVF_CLR_INTFLAG(instance)                                        \
  (instance->COUNT16.INTFLAG.bit.OVF = 0x01)
#define ML_TC_ERR_CLR_INTFLAG(instance)                                        \
  (instance->COUNT16.INTFLAG.bit.ERR = 0x01)
#define ML_TC_MC0_CLR_INTFLAG(instance)                                        \
  (instance->COUNT16.INTFLAG.bit.MC0 = 0x01)
#define ML_TC_MC1_CLR_INTFLAG(instance)                                        \
  (instance->COUNT16.INTFLAG.bit.MC1 = 0x01)

#define ML_TC_CLR_INTFLAGS(instance)                                           \
  (instance->COUNT16.INTFLAG.reg = TC_INTFLAG_MASK)
