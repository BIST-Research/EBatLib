...
typedef enum { PP_ODD, PP_EVEN } ml_port_parity;

typedef enum { DRIVE_OFF = 0x00, DRIVE_ON = 0x01 } ml_port_drive_strength;
...
typedef enum { PORT_GRP_A, PORT_GRP_B, PORT_GRP_C, PORT_GRP_D } ml_port_group;
