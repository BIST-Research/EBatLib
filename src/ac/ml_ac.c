...
void AC_init(void) {
  ...
  AC->COMPCTRL[AC_CHANNEL].reg |=
      (AC_COMPCTRL_MUXPOS_PIN3 | AC_COMPCTRL_MUXNEG_GND |
       AC_COMPCTRL_SPEED_HIGH | AC_COMPCTRL_HYST_HYST150 |
       AC_COMPCTRL_FLEN_MAJ5 | AC_COMPCTRL_INTSEL_TOGGLE |
