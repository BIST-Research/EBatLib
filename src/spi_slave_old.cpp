...
const uint16_t spi_rx_dmac_descriptor_settings =
    (DMAC_BTCTRL_BEATSIZE_WORD | DMAC_BTCTRL_DSTINC | DMAC_BTCTRL_BLOCKACT_INT |
     DMAC_BTCTRL_VALID);
...
const uint16_t spi_tx_dmac_descriptor_settings =
    (DMAC_BTCTRL_VALID | DMAC_BTCTRL_BLOCKACT_INT | DMAC_BTCTRL_BEATSIZE_WORD |
     DMAC_BTCTRL_SRCINC);
...
void spi_slave_init(void) {
  ...
  ml_pin_settings pad2 = {PORT_GRP_B,     22,       PF_C, PP_EVEN,
                          INPUT_STANDARD, DRIVE_OFF};
...
void SERCOM1_2_Handler(void) { rxc_intflag = true; }
