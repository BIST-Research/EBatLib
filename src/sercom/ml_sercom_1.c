...
const uint16_t sercom1_spi_rx_master_dmac_descriptor_settings =
    (DMAC_BTCTRL_BEATSIZE_BYTE | DMAC_BTCTRL_DSTINC |
     DMAC_BTCTRL_BLOCKACT_BOTH | DMAC_BTCTRL_VALID);

const uint16_t sercom1_spi_rx_slave_dmac_descriptor_settings =
    (DMAC_BTCTRL_BEATSIZE_BYTE | DMAC_BTCTRL_DSTINC | DMAC_BTCTRL_BLOCKACT_INT |
     DMAC_BTCTRL_VALID);
...
const uint16_t sercom1_spi_tx_master_dmac_descriptor_settings =
    (DMAC_BTCTRL_VALID | DMAC_BTCTRL_BLOCKACT_BOTH | DMAC_BTCTRL_BEATSIZE_BYTE |
     DMAC_BTCTRL_SRCINC);

const uint16_t sercom1_spi_tx_slave_dmac_descriptor_settings =
    (DMAC_BTCTRL_VALID | DMAC_BTCTRL_BLOCKACT_INT | DMAC_BTCTRL_BEATSIZE_BYTE |
     DMAC_BTCTRL_SRCINC);
...
const ml_spi_s sercom1_spi_dmac_master_prototype = {
    ...
    .ss_timer_inst = TC0,
    .ss_timer_idx = CC0,
    .rx_dmac_s = {.chan_prilvl = PRILVL0,
                  .ex_chnum = DMAC_CH0,
                  .irqn = DMAC_0_IRQn,
                  .irqn_prilvl = 2,
                  .chan_settings = sercom1_spi_rx_dmac_channel_settings,
                  .descriptor_settings =
                      sercom1_spi_rx_master_dmac_descriptor_settings,
                  .intmsk = SERCOM1_SPI_DMAC_INTMSK,
                  .nvic = true},
    .tx_dmac_s = {.chan_prilvl = PRILVL0,
                  .ex_chnum = DMAC_CH1,
                  .irqn = DMAC_1_IRQn,
                  .irqn_prilvl = 2,
                  .chan_settings = sercom1_spi_tx_dmac_channel_settings,
                  .descriptor_settings =
                      sercom1_spi_tx_master_dmac_descriptor_settings,
                  .intmsk = SERCOM1_SPI_DMAC_INTMSK,
                  .nvic = true}};
...
const ml_spi_s sercom1_spi_dmac_slave_prototype = {
    ...
    .rx_dmac_s = {.chan_prilvl = PRILVL0,
                  ...
                  .chan_settings = sercom1_spi_rx_dmac_channel_settings,
                  .descriptor_settings =
                      sercom1_spi_rx_slave_dmac_descriptor_settings,
                  .intmsk = SERCOM1_SPI_DMAC_INTMSK,
                  .nvic = true},
    .tx_dmac_s = {.chan_prilvl = PRILVL0,
                  .ex_chnum = DMAC_CH1,
                  ...
                  .chan_settings = sercom1_spi_tx_dmac_channel_settings,
                  .descriptor_settings =
                      sercom1_spi_tx_slave_dmac_descriptor_settings,
                  .intmsk = SERCOM1_SPI_DMAC_INTMSK,
                  .nvic = true}};
